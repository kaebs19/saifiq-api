...
import { usePlayerTransactions } from '../../hooks/usePlayers';
...
export default function PlayerTransactionsTab({ playerId }) {
  const [filters, setFilters] = useState({ page: 1, limit: 10 });
  const { data, isLoading } = usePlayerTransactions(playerId, filters);
